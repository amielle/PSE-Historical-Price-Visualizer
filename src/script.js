...
var side_margin = window.innerWidth/10;

var margin = {top: 50, right: side_margin, bottom: 125, left: side_margin },
margin2  = {top: 300, right: side_margin, bottom: 20, left: side_margin},
width    = window.innerWidth  - margin.left - margin.right,
height   = 500 - margin.top - margin.bottom,
height2  = 375 - margin2.top - margin2.bottom;
...
var strComp = e.options[e.selectedIndex].value;
console.log(strComp);
...
var barsGroup = svg.append('g')
  ...
  .attr('transform', 'translate(' + margin.left + ',' + (margin2.top + 20) + ')');
...
d3.csv("/prices/".concat(strComp, '.csv'), type, function(err, data) {
  ...
  var dateRange = ['1w', '1m', '3m', '6m', '1y', '5y', '10y']
